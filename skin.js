...
// Generated Чт мар 13 23:20:45 2025

function pano2vrSkin(player,base) {
	var ggSkinVars = [];
	ggSkinVars['vis_Floorplan'] = false;
	ggSkinVars['vis_levels'] = 0;
	var me=this;
	var flag=false;
	var nodeMarker=[];
	...
	this.addSkin=function() {
		...
		this._floor_plan=document.createElement('div');
		this._floor_plan.ggId="Floor plan";
		this._floor_plan.ggLeft=-645;
		this._floor_plan.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._floor_plan.ggVisible=true;
		this._floor_plan.className='ggskin ggskin_container ';
		this._floor_plan.ggType='container';
		hs ='';
		hs+='height : 35px;';
		hs+='left : -645px;';
		hs+='opacity : 0;';
		...
		hs+='width : 200px;';
		hs+='pointer-events:none;';
		this._floor_plan.setAttribute('style',hs);
		this._floor_plan.style[domTransform + 'Origin']='50% 50%';
		me._floor_plan.ggIsActive=function() {
			return false;
		}
		me._floor_plan.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		me._floor_plan.ggCurrentLogicStateAlpha = -1;
		this._floor_plan.ggUpdateConditionTimer=function () {
			var newLogicStateAlpha;
			if (
				(ggSkinVars['vis_Floorplan'] == true)
			)
			{
			...
			if (me._floor_plan.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._floor_plan.style[domTransition]='opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._floor_plan.ggCurrentLogicStateAlpha == 0) {
					...
					me._floor_plan.style.opacity=0;
				}
			}
		}
		this._floor_plan.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._flat_32=document.createElement('div');
		this._flat_32__img=document.createElement('img');
		this._flat_32__img.className='ggskin ggskin_image';
		this._flat_32__img.setAttribute('src',basePath + 'images/flat_32.png');
		this._flat_32__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._flat_32__img.className='ggskin ggskin_image';
		this._flat_32__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._flat_32__img);
		this._flat_32.appendChild(this._flat_32__img);
		this._flat_32.ggId="Flat 32";
		this._flat_32.ggLeft=75;
		this._flat_32.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._flat_32.ggVisible=true;
		this._flat_32.className='ggskin ggskin_image ';
		this._flat_32.ggType='image';
		hs ='';
		hs+='height : 330px;';
		hs+='left : 75px;';
		hs+='position : absolute;';
		...
		hs+='width : 380px;';
		hs+='pointer-events:auto;';
		this._flat_32.setAttribute('style',hs);
		this._flat_32.style[domTransform + 'Origin']='50% 50%';
		me._flat_32.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._flat_32.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._flat_32.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._hide_container.ggLeft=-100;
		this._hide_container.ggTop=-84;
		...
		this._ut5=document.createElement('div');
		this._ut5__text=document.createElement('div');
		this._ut5.className='ggskin ggskin_textdiv';
		this._ut5.ggTextDiv=this._ut5__text;
		this._ut5.ggId="$ut";
		this._ut5.ggLeft=-628;
		this._ut5.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ut5.ggVisible=false;
		this._ut5.className='ggskin ggskin_text ';
		this._ut5.ggType='text';
		hs ='';
		hs+='height : 21px;';
		hs+='left : -628px;';
		hs+='position : absolute;';
		...
		hs+='width : 117px;';
		hs+='pointer-events:auto;';
		this._ut5.setAttribute('style',hs);
		this._ut5.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._ut5__text.setAttribute('style',hs);
		this._ut5.ggUpdateText=function() {
		...
		me._ut5.ggUpdateText();
		this._ut5.appendChild(this._ut5__text);
		me._ut5.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut5.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ut5.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._markertemplate.appendChild(this._ut5);
		this._hide_container.appendChild(this._markertemplate);
		this._flat_32.appendChild(this._hide_container);
		...
		this._marker_node5.ggLeft=0;
		this._marker_node5.ggTop=62;
		...
		this._ut4=document.createElement('div');
		this._ut4__text=document.createElement('div');
		this._ut4.className='ggskin ggskin_textdiv';
		this._ut4.ggTextDiv=this._ut4__text;
		this._ut4.ggId="$ut";
		this._ut4.ggLeft=-57;
		this._ut4.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ut4.ggVisible=false;
		this._ut4.className='ggskin ggskin_text ';
		this._ut4.ggType='text';
		hs ='';
		hs+='height : 21px;';
		hs+='left : -57px;';
		hs+='position : absolute;';
		...
		hs+='width : 111px;';
		hs+='pointer-events:auto;';
		this._ut4.setAttribute('style',hs);
		this._ut4.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='overflow: hidden;';
		this._ut4__text.setAttribute('style',hs);
		this._ut4__text.innerHTML="FLAT 32 Hallway";
		this._ut4.appendChild(this._ut4__text);
		me._ut4.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut4.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ut4.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._marker_node5.appendChild(this._ut4);
		...
		this._marker_node6.ggLeft=-27;
		this._marker_node6.ggTop=-16;
		...
		this._ut3=document.createElement('div');
		this._ut3__text=document.createElement('div');
		this._ut3.className='ggskin ggskin_textdiv';
		this._ut3.ggTextDiv=this._ut3__text;
		this._ut3.ggId="$ut";
		this._ut3.ggLeft=-77;
		this._ut3.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ut3.ggVisible=false;
		this._ut3.className='ggskin ggskin_text ';
		this._ut3.ggType='text';
		hs ='';
		hs+='height : 21px;';
		hs+='left : -77px;';
		hs+='position : absolute;';
		...
		hs+='width : 134px;';
		hs+='pointer-events:auto;';
		this._ut3.setAttribute('style',hs);
		this._ut3.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 4px 5px 4px 5px;';
		hs+='overflow: hidden;';
		this._ut3__text.setAttribute('style',hs);
		this._ut3__text.innerHTML="Guestroom & Kitchen";
		this._ut3.appendChild(this._ut3__text);
		me._ut3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut3.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ut3.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
			...
			this.style[domTransition]='none';
			this.ggTextDiv.style.left=((136-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		this._marker_node6.appendChild(this._ut3);
		...
		this._marker_node3.ggLeft=63;
		this._marker_node3.ggTop=62;
		...
		this._ut2=document.createElement('div');
		this._ut2__text=document.createElement('div');
		this._ut2.className='ggskin ggskin_textdiv';
		this._ut2.ggTextDiv=this._ut2__text;
		this._ut2.ggId="$ut";
		this._ut2.ggLeft=-37;
		this._ut2.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ut2.ggVisible=false;
		this._ut2.className='ggskin ggskin_text ';
		this._ut2.ggType='text';
		hs ='';
		hs+='height : 21px;';
		hs+='left : -37px;';
		hs+='position : absolute;';
		...
		hs+='width : 85px;';
		hs+='pointer-events:auto;';
		this._ut2.setAttribute('style',hs);
		this._ut2.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 4px 5px 4px 5px;';
		hs+='overflow: hidden;';
		this._ut2__text.setAttribute('style',hs);
		this._ut2__text.innerHTML="Bedroom 1";
		this._ut2.appendChild(this._ut2__text);
		me._ut2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut2.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ut2.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
			...
			this.style[domTransition]='none';
			this.ggTextDiv.style.left=((87-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		this._marker_node3.appendChild(this._ut2);
		this._flat_32.appendChild(this._marker_node3);
		...
		this._marker_node4.ggLeft=63;
		this._marker_node4.ggTop=-16;
		...
		this._ut1=document.createElement('div');
		this._ut1__text=document.createElement('div');
		this._ut1.className='ggskin ggskin_textdiv';
		this._ut1.ggTextDiv=this._ut1__text;
		this._ut1.ggId="$ut";
		this._ut1.ggLeft=-60;
		this._ut1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ut1.ggVisible=false;
		this._ut1.className='ggskin ggskin_text ';
		this._ut1.ggType='text';
		hs ='';
		hs+='height : 21px;';
		hs+='left : -60px;';
		hs+='position : absolute;';
		...
		hs+='width : 85px;';
		hs+='pointer-events:auto;';
		this._ut1.setAttribute('style',hs);
		this._ut1.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 4px 5px 4px 5px;';
		hs+='overflow: hidden;';
		this._ut1__text.setAttribute('style',hs);
		this._ut1__text.innerHTML="Bedroom 2";
		this._ut1.appendChild(this._ut1__text);
		me._ut1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ut1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._marker_node4.appendChild(this._ut1);
		...
		this._marker_node2.ggLeft=-57;
		this._marker_node2.ggTop=62;
		...
		this._ut0=document.createElement('div');
		this._ut0__text=document.createElement('div');
		this._ut0.className='ggskin ggskin_textdiv';
		this._ut0.ggTextDiv=this._ut0__text;
		this._ut0.ggId="$ut";
		this._ut0.ggLeft=-53;
		this._ut0.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ut0.ggVisible=false;
		this._ut0.className='ggskin ggskin_text ';
		this._ut0.ggType='text';
		hs ='';
		hs+='height : 21px;';
		hs+='left : -53px;';
		hs+='position : absolute;';
		...
		hs+='width : 85px;';
		hs+='pointer-events:auto;';
		this._ut0.setAttribute('style',hs);
		this._ut0.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 4px 5px 4px 5px;';
		hs+='overflow: hidden;';
		this._ut0__text.setAttribute('style',hs);
		this._ut0__text.innerHTML="Bathroom";
		this._ut0.appendChild(this._ut0__text);
		me._ut0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut0.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ut0.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		this._marker_node2.appendChild(this._ut0);
		this._flat_32.appendChild(this._marker_node2);
		...
		this._ut=document.createElement('div');
		this._ut__text=document.createElement('div');
		...
		hs+='width : 117px;';
		hs+='pointer-events:auto;';
		this._ut.setAttribute('style',hs);
		this._ut.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._ut__text.setAttribute('style',hs);
		this._ut__text.innerHTML="";
		this._ut.appendChild(this._ut__text);
		me._ut.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._ut.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		...
		this._marker_node1.appendChild(this._ut);
		this._flat_32.appendChild(this._marker_node1);
		this._floor_plan.appendChild(this._flat_32);
		this.divSkin.appendChild(this._floor_plan);
		this._toggle_floor_plan=document.createElement('div');
		this._toggle_floor_plan__text=document.createElement('div');
		this._toggle_floor_plan.className='ggskin ggskin_textdiv';
		this._toggle_floor_plan.ggTextDiv=this._toggle_floor_plan__text;
		this._toggle_floor_plan.ggId="Toggle floor plan";
		this._toggle_floor_plan.ggTop=-35;
		this._toggle_floor_plan.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._toggle_floor_plan.ggVisible=true;
		this._toggle_floor_plan.className='ggskin ggskin_text ';
		this._toggle_floor_plan.ggType='text';
		hs ='';
		hs+='height : 24px;';
		hs+='left : 8px;';
		hs+='position : absolute;';
		...
		hs+='width : 114px;';
		hs+='pointer-events:auto;';
		this._toggle_floor_plan.setAttribute('style',hs);
		this._toggle_floor_plan.style[domTransform + 'Origin']='0% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='overflow: hidden;';
		this._toggle_floor_plan__text.setAttribute('style',hs);
		this._toggle_floor_plan__text.innerHTML="Show Floor Plan";
		this._toggle_floor_plan.appendChild(this._toggle_floor_plan__text);
		me._toggle_floor_plan.ggIsActive=function() {
			return false;
		}
		me._toggle_floor_plan.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._toggle_floor_plan.onclick=function (e) {
			ggSkinVars['vis_Floorplan'] = !ggSkinVars['vis_Floorplan'];
		}
		this._toggle_floor_plan.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
			...
			this.style[domTransition]='none';
			this.ggTextDiv.style.left=((122-this.ggTextDiv.offsetWidth)*0) + 'px';
		}
		this.divSkin.appendChild(this._toggle_floor_plan);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
		...
		this._markertemplate__normal.style.left='-11px';
		this._markertemplate__normal.style.top='-11px';
		this._markertemplate.ggMarkerNormal=this._markertemplate__normal;
		this._markertemplate__active=new SkinElement_marker_active_Class(this,this._markertemplate);
		this._markertemplate__active.style.visibility='hidden';
		this._markertemplate__active.style.left='-12px';
		this._markertemplate__active.style.top='-12px';
		...
		this._marker_node5__normal.style.left='-11px';
		this._marker_node5__normal.style.top='-11px';
		...
		this._marker_node5__active.style.left='-12px';
		this._marker_node5__active.style.top='-12px';
		...
		this._marker_node6__normal.style.left='-11px';
		this._marker_node6__normal.style.top='-11px';
		...
		this._marker_node6__active.style.left='-12px';
		this._marker_node6__active.style.top='-12px';
		...
		this._marker_node3__normal.style.left='-11px';
		this._marker_node3__normal.style.top='-11px';
		...
		this._marker_node3__active.style.left='-12px';
		this._marker_node3__active.style.top='-12px';
		...
		this._marker_node4__normal.style.left='-11px';
		this._marker_node4__normal.style.top='-11px';
		...
		this._marker_node4__active.style.left='-12px';
		this._marker_node4__active.style.top='-12px';
		...
		this._marker_node2__normal.style.left='-11px';
		this._marker_node2__normal.style.top='-11px';
		...
		this._marker_node2__active.style.left='-12px';
		this._marker_node2__active.style.top='-12px';
		...
		this._marker_node1__normal.style.left='-11px';
		this._marker_node1__normal.style.top='-11px';
		...
		this._marker_node1__active.style.left='-12px';
		this._marker_node1__active.style.top='-12px';
	...
	this.skinTimerEvent=function() {
		...
		me._datetime.ggUpdateText();
		me._copyright.ggUpdateText();
		me._floor_plan.ggUpdateConditionTimer();
		var hs='';
		if (me._markertemplate.ggParameter) {
			hs+=parameterToTransform(me._markertemplate.ggParameter) + ' ';
		}
		hs+='rotate(' + (-1.0*(1 * me.player.getPanNorth() + 0)) + 'deg) ';
		me._markertemplate.style[domTransform]=hs;
		me._ut5.ggUpdateText();
	...
	function SkinElement_marker_active_Class(skinObj,ggParent) {
		...
		this._marker_active.ggLeft=-50;
		this._marker_active.ggTop=34;
	...
	function SkinElement_marker_normal_Class(skinObj,ggParent) {
		...
		this._marker_normal.ggLeft=-49;
		this._marker_normal.ggTop=65;
